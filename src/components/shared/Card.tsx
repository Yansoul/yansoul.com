...
Card.Link = function CardLink({
  ...
  return (
    <>
      <div className="absolute -inset-x-4 -inset-y-3 z-0 scale-95 transition group-hover:scale-100 group-hover:bg-muted/50 sm:-inset-x-6 sm:rounded-2xl " />
      <Link {...props}>
        <span className="absolute -inset-x-4 -inset-y-3 z-20 sm:-inset-x-6 sm:rounded-2xl" />
